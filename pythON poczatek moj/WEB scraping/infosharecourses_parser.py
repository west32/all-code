...
class InfoShareParser:
    PAGE_URL = "https://infoshareacademy.com/kursy/"
    ...
    def search_for_next_post_preview(self):
        ...
        time,time_index = self._find_time(title_index)
        type,type_index= self._find_type(time_index)
        self.last_post_index= type_index
        self.found_post_previews.append(PostPreview(title,time,type))
