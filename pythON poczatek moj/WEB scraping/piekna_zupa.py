...
class PyjazzParser:
    ...
    #     tag_p = self.parsed_page.p
        ...
        # print(self.parsed_page.div.find_all(is_a_and_has_rel_bookmark))
    ...
    #     for published_date_tag,title_tag in zip (publish_date_tags, title_tags):
    #         post_preview - PostPreview(publish_date_tag.string, title_tag.string)
    #         self.found_post_previews(post_preview)

    def parse_all_previews(self):
        publish_date_tags= self.parsed_page.find_all(is_publish_date_containing_tag)
        title_tags = self.parsed_page.find_all(is_title_containing_tag)
        for publish_date_tags,title_tags in zip (publish_date_tags,title_tags):
            post_preview= PostPreview(publish_date_tags.string,title_tags.string)
