...
def save_store(available_products, file_name="available_products.csv"):
...
def load_store(file_name="available_products.csv"):
        ...
        Order(
            ...
            order_elements=[OrderElement(
                ...
                product=Product(
                    ...
                    price=order_element["product"]["unit_price"],
                    identifier=order_element["product"]["identifier"],
                )
            ) for order_element in order["order_elements"]],
        ) for order in orders
